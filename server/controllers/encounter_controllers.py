...
from controllers.monster_controllers import *
...
def create_new_encounter(user_content: str, user_id: int):
    try:
        ...
        #Database Operations
        encounter = Encounter(user_id=user_id)
...
def get_encounter_json(encounter_id: int, user_id: int):
    e = Encounter.query.filter_by(id=encounter_id, user_id=user_id).first()
